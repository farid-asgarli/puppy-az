...
public static class ValidationPatterns
{
	...
	/// Accepts format: XXXXXXXXX (9 digits, no leading zero)
	/// where XX is a valid operator code.
	/// Examples: 501234567, 101234567
	/// </summary>
	public const string AzerbaijaniPhoneNumber = @"^(10|50|51|55|60|65|70|77|99)\d{7}$";
