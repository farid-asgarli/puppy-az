...
public class CreatePetCategoryCommandValidator : BaseValidator<CreatePetCategoryCommand>
{
	public CreatePetCategoryCommandValidator(IStringLocalizer localizer)
		: base(localizer)
	{
