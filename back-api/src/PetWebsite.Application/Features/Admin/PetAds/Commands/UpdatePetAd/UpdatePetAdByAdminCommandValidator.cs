...
public class UpdatePetAdByAdminCommandValidator : AbstractValidator<UpdatePetAdByAdminCommand>
{
	public UpdatePetAdByAdminCommandValidator(IStringLocalizer localizer)
	{
		RuleFor(x => x.Id)
