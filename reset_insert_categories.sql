-- Reset pet categories to clean state
DELETE FROM "PetAds";
...
-- Insert new 10 categories with localizations
INSERT INTO "PetCategories" ("SvgIcon", "IconColor", "BackgroundColor", "IsActive", "CreatedAt")
VALUES
