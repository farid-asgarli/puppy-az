...
import { IconPaw, IconDog, IconCat, IconFeather, IconFish } from '@tabler/icons-react';
...
> = {
  az: {
    ...
    description: 'Deyəsən bu səhifə evdən qaçıb! Yeni tüklü dost tapmaq üçün axtarışa başlayın.',
    homePage: 'Ana səhifə',
  ...
  en: {
    ...
    description: 'Looks like this page ran away from home! Start searching to find a new furry friend.',
    homePage: 'Home page',
    viewAds: 'View ads',
  ...
  ru: {
    ...
    description: 'Похоже, эта страница убежала из дома! Начните поиск, чтобы найти нового пушистого друга.',
    homePage: 'Главная',
...
const searchMessages: Record<Locale, Record<string, unknown>> = {
  az: {
    search: {
      ...
      searchTipsActive: 'Filtrləri dəyişmək üçün istənilən sahəyə toxunun. Hamısını təmizləmək üçün sıfırdan başlayın.',
      searchTipsInactive: 'Mükəmməl ev heyvanınızı tapmaq üçün filtrləri seçin. Bir neçə meyar birləşdirə bilərsiniz.',
  ...
  en: {
    search: {
      ...
      searchTipsActive: 'Tap any field to change filters. Start fresh to clear all.',
      searchTipsInactive: 'Select filters to find your perfect pet. You can combine multiple criteria.',
      clearAll: 'Clear all',
      searchButton: 'Search',
      yearsOld: 'years old',
      helperText: {
  ...
  ru: {
    search: {
      ...
      searchTipsActive: 'Нажмите на любое поле, чтобы изменить фильтры. Начните заново, чтобы очистить все.',
      searchTipsInactive: 'Выберите фильтры, чтобы найти идеального питомца. Можно комбинировать несколько критериев.',
...
const WomanHoldingDogAnimation = dynamic(() => import('@/lib/components/animations/woman-holding-dog'), { ssr: false });
      ...
      <FilterDialogContext.Provider value={filterDialogValue}>
        <div className='min-h-screen bg-gradient-to-br from-slate-50 via-purple-50/20 to-indigo-50/30 flex items-center justify-center px-4 py-8 overflow-visible relative'>
          ...
          <div className='absolute inset-0 overflow-hidden pointer-events-none'>
            ...
            <div className='absolute top-[10%] right-[15%] animate-bounce' style={{ animationDuration: '4s' }}>
              <IconPaw className='w-8 h-8 text-purple-200/40 rotate-[15deg]' />
            </div>
            <div className='absolute bottom-[20%] left-[10%] animate-bounce' style={{ animationDuration: '3.5s', animationDelay: '0.5s' }}>
              <IconPaw className='w-6 h-6 text-indigo-200/40 rotate-[-20deg]' />
            </div>
            <div className='absolute top-[30%] left-[5%] animate-bounce' style={{ animationDuration: '4.5s', animationDelay: '1s' }}>
          ...
          <div className='relative z-10 flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-16 w-full max-w-6xl'>
            ...
            <div className='flex flex-col items-center lg:items-start text-center lg:text-left max-w-lg'>
              {/* Simple 404 */}
              <div className='mb-6'>
                <span className='text-8xl sm:text-9xl lg:text-[180px] font-black text-neutral-800 leading-none tracking-tight'>404</span>
              </div>

              {/* Main heading */}
              <h1 className='text-2xl sm:text-3xl lg:text-4xl font-bold text-neutral-800 tracking-tight leading-tight'>{t.title}</h1>

              <p className='text-neutral-500 mt-3 text-base max-w-md'>{t.description}</p>
              ...
              <div className='mt-8 w-full'>
                <p className='text-xs text-neutral-400 uppercase tracking-wider mb-3 font-medium'>{t.popularCategories}</p>
                <div className='flex flex-wrap items-center justify-center lg:justify-start gap-2'>
                  ...
                  >
                    ...
                    <span className='text-neutral-600 group-hover:text-purple-700'>{t.dogs}</span>
                  </Link>
                  <Link
                  ...
                  >
                    ...
                    <span className='text-neutral-600 group-hover:text-blue-700'>{t.cats}</span>
                  </Link>
                  <Link
                  ...
                  >
                    ...
                    <span className='text-neutral-600 group-hover:text-emerald-700'>{t.birds}</span>
                  </Link>
                  <Link
                  ...
                  >
                    ...
                    <span className='text-neutral-600 group-hover:text-cyan-700'>{t.fish}</span>
                  </Link>
                </div>
              </div>
            </div>
