...
// Category slug mappings per locale (for hardcoded links)
const CATEGORY_SLUGS: Record<Locale, Record<number, string>> = {
  az: { 1: "itler", 2: "pisikler", 3: "quslar", 4: "baliqlar" },
  en: { 1: "dogs", 2: "cats", 3: "birds", 4: "fish" },
  ru: { 1: "sobaki", 2: "koshki", 3: "ptitsy", 4: "ryby" },
};
            ...
            <div className="flex flex-col items-center lg:items-start text-center lg:text-left max-w-lg">
              ...
              <div className="mt-8 w-full">
                ...
                <div className="flex flex-wrap items-center justify-center lg:justify-start gap-2">
                  <Link
                    href={`/${locale}/${CATEGORY_SLUGS[locale][1]}`}
                  ...
                  <Link
                    href={`/${locale}/${CATEGORY_SLUGS[locale][2]}`}
                  ...
                  <Link
                    href={`/${locale}/${CATEGORY_SLUGS[locale][3]}`}
                  ...
                  <Link
                    href={`/${locale}/${CATEGORY_SLUGS[locale][4]}`}
