...
export class FilterValidator {
  ...
  private static readonly VALID_SORTS = ['newest', 'oldest', 'price-low', 'price-high', 'distance'];
  ...
  static validateFilters(params: Record<string, string>): FilterParams {
    ...
    if (validated['price-min'] && validated['price-max'] && validated['price-min'] > validated['price-max']) {
   ...
   */
  static buildFilterUrl(filters: FilterParams, basePath: string = '/ads/s'): string {
