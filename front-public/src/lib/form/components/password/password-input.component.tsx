      ...
      <div className={cn('mb-4', fullWidth && 'w-full', containerClassName)}>
        ...
        >
          ...
          <div className="flex items-center px-4 shrink-0">
            <IconLock size={18} className={cn('text-gray-400', error && 'text-red-500')} />
          </div>
          ...
          {showPasswordToggle && !disabled && (
            ...
            >
              {showPassword ? (
                <IconEyeOff size={18} className={cn('text-gray-400', error && 'text-red-500')} />
              ) : (
                <IconEye size={18} className={cn('text-gray-400', error && 'text-red-500')} />
              )}
            </button>
          )}
        </div>
