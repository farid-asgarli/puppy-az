  ...
  (
    ...
    return (
      <button
        ...
        className={cn(
          // Base styles
          "relative inline-flex items-center justify-center font-medium transition-all duration-200 rounded-2xl focus:outline-none",
          ...
          variant === "default" &&
            !isActive &&
            "bg-gray-50 border-2 border-gray-200 text-gray-700 hover:border-gray-300 hover:bg-white",
          variant === "default" &&
            isActive &&
            "bg-gray-900 border-2 border-gray-900 text-white hover:bg-black hover:border-black",
          // Visual state - Primary variant
          variant === "primary" &&
            !isActive &&
            "bg-gray-50 border-gray-200 text-primary hover:border-gray-300 hover:bg-white focus:ring-primary",
          variant === "primary" &&
            isActive &&
            "bg-primary border-primary text-white hover:bg-primary-dark focus:ring-primary",
          ...
          variant === "outline" &&
            isActive &&
            "bg-gray-100 border-gray-700 text-gray-900 hover:bg-gray-200 focus:ring-gray-700",
          className,
        )}
        ...
        {IconComponent && (
          <span className="inline-flex items-center mr-2">
            <IconComponent
              ...
              stroke={1.5}
              className={cn(
                isActive && variant === "primary" ? "text-white" : "",
              )}
            />
          </span>
        )}
 ...
 */
export function PlusIconToggleButton({
  children,
  ...props
}: ToggleButtonProps) {
