...
import { IconUser, IconMail, IconCamera, IconDeviceFloppy, IconX } from '@tabler/icons-react';
    ...
    try {
      ...
      if (result.success) {
        ...
        reset({
          ...
          phoneNumber: result.data.phoneNumber?.replace('+994', '').trim() || '',
            ...
            <div className="p-4 sm:p-6 rounded-xl border-2 border-gray-200">
              <div className="flex items-center gap-4 sm:gap-6">
                <div className="relative flex-shrink-0">
                  ...
                  <IconButton
                    icon={<IconCamera size={14} className="sm:w-4 sm:h-4 text-white" />}
                    variant="primary"
                    size="md"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <TextInput
                  ...
                  {...register('firstName', {
                    ...
                    minLength: { value: 2, message: t('personalInfo.firstName.minLength') },
                    maxLength: { value: 50, message: t('personalInfo.firstName.maxLength') },
                  })}
                />
                ...
                <TextInput
                  ...
                  {...register('lastName', {
                    ...
                    minLength: { value: 2, message: t('personalInfo.lastName.minLength') },
                    maxLength: { value: 50, message: t('personalInfo.lastName.maxLength') },
                  })}
                />
