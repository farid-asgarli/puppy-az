          ...
          <div className="space-y-6 sm:space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-6 items-start">
              ...
              <div className="relative flex-shrink-0 mx-auto sm:mx-0">
                <Avatar src={userData.avatar} name={userData.name} size="xl" rounded="2xl" />
                {userData.isVerified && (
              ...
              <div className="grid grid-cols-2 sm:grid-cols-5 gap-3 sm:gap-4">
                ...
                >
                  <div className="relative inline-block">
                    <Heading variant="section" className={cn('mb-1 text-xl sm:text-2xl lg:text-3xl', unreadMessagesCount > 0 && 'text-red-600')}>
                      {unreadMessagesCount}
                    </Heading>
                    {unreadMessagesCount > 0 && <div className="absolute -top-1 -right-6 w-2 h-2 bg-red-500 rounded-full animate-pulse"></div>}
                  </div>
                  <Text variant="small" color="secondary" className="text-xs sm:text-sm">
                ...
                >
                  <div className="relative inline-block">
                    <Heading
                      variant="section"
                      className={cn('mb-1 text-xl sm:text-2xl lg:text-3xl', userData.stats.unansweredQuestions > 0 && 'text-red-600')}
                    >
