...
export function StepProgress() {
  ...
  let maxReachedStepIndex = steps.findIndex((s) => s.path === maxReachedStepPath);
      ...
      <div className='max-w-4xl mx-auto px-4 sm:px-6 py-3 sm:py-4'>
        ...
        <div className='flex items-center justify-between mb-2 sm:mb-3'>
          <div className='flex items-center gap-1.5 sm:gap-2 min-w-0'>
            ...
            {currentStepIndex >= 0 && <span className='text-xs sm:text-sm text-gray-500 truncate'>• {t(steps[currentStepIndex].key)}</span>}
          </div>
          <span className='text-xs sm:text-sm font-medium text-primary-600 shrink-0 ml-2'>{Math.round(progress)}%</span>
        </div>
                ...
                >
                  ...
                  <div
                    className={cn(
                      ...
                      isCurrent && 'bg-primary-100 ring-2 ring-primary-500 ring-offset-2',
                      isMaxReached && !isCurrent && 'bg-primary-50 ring-1 ring-primary-300 animate-pulse-subtle',
                      isReached && !isCurrent && !isMaxReached && 'bg-primary-100 opacity-70',
                  ...
                  >
                    {isCompleted ? (
                      ...
                      <Icon
                        size={16}
                        strokeWidth={2}
                        className={cn(isReached && !isCurrent && 'opacity-70', isMaxReached && !isCurrent && 'animate-pulse-subtle')}
                      />
                    )}
                  </div>
            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  isReached && !isCurrent && !isCompleted && 'bg-primary-300 flex-1',
