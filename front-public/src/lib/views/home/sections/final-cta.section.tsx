...
import { IconSearch, IconPlus, IconPaw, IconHeart, IconSparkles } from '@tabler/icons-react';
        ...
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 p-8 sm:p-12 lg:p-16">
          ...
          <div className="relative max-w-3xl mx-auto text-center space-y-6 sm:space-y-8">
            ...
            <div className="space-y-3 sm:space-y-4">
              <h2 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold font-heading text-white leading-tight">{t('title')}</h2>
              <p className="text-base sm:text-lg lg:text-xl text-gray-300 leading-relaxed max-w-2xl mx-auto">{t('subtitle')}</p>
            </div>
            ...
            <div className="pt-6 sm:pt-8">
              <div className="flex flex-wrap items-center justify-center gap-4 sm:gap-6 text-sm sm:text-base text-gray-300">
                ...
                <div className="flex items-center gap-2">
                  <IconHeart size={18} className="text-accent-400 fill-accent-400" />
