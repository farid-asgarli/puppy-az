...
const AboutView = () => {
  ...
  const formatNumber = (num: number) => {
    ...
    // 500-lük intervallarla yuvarlaşdır
    const roundedDown = Math.floor(num / 500) * 500;
    return `${roundedDown.toLocaleString()}+`;
  };

  const stats = [
    {
      value: realStats ? formatNumber(realStats.activeAds) : "...",
      label: t("stats.activeAds"),
      icon: IconPaw,
    },
    {
      value: realStats ? formatNumber(realStats.totalUsers) : "...",
      label: t("stats.users"),
      icon: IconUsers,
    },
  ...
  const milestones = [
    {
      year: t("milestones.idea.year"),
      title: t("milestones.idea.title"),
      description: t("milestones.idea.description"),
    },
    {
      year: t("milestones.research.year"),
      title: t("milestones.research.title"),
      description: t("milestones.research.description"),
    },
    {
      year: t("milestones.development.year"),
      title: t("milestones.development.title"),
      description: t("milestones.development.description"),
    },
    {
      year: t("milestones.launch.year"),
        ...
        <div className="space-y-20">
              ...
              <div className="relative bg-white border border-gray-200 rounded-3xl p-8 shadow-sm">
                <div className="flex items-start gap-4 mb-6">
                  <div className="w-12 h-12 bg-primary-50 rounded-2xl flex items-center justify-center flex-shrink-0">
                    <IconPaw className="w-6 h-6 text-primary-600" />
                  </div>
                  <div>
          ...
          <div className="space-y-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              {/* CTA */}
              <div className="p-8 rounded-2xl bg-white border border-gray-200 shadow-sm space-y-6">
