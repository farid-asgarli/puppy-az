  ...
  return (
    <div className='space-y-8'>
      <div className='max-w-3xl mx-auto text-center space-y-6'>
        <Heading variant='display'>Azərbaycanda heyvan alış-verişini təhlükəsiz və asan edən platforma</Heading>

        <Text variant='body-xl' leading='relaxed'>
          puppy.az 2023-cü ildə Azərbaycanda heyvan sevənləri üçün etibarlı və istifadəçi dostu bir platforma yaratmaq missiyası ilə quruldu.
        </Text>

        <Text variant='body-xl' leading='relaxed'>
          Biz heyvanların layiqli yuva tapması və onlara qayğı göstərəcək məsuliyyətli sahiblərlə görüşməsində köməkçi olmaq istəyirik.
        </Text>
      </div>
    </div>
  );
...
export function CardContentExample() {
  return (
    <div className='p-6 rounded-xl border-2 border-gray-200 space-y-4'>
      ...
      <Text variant='body'>Premium elanlar orta hesabla 5-7 dəfə daha tez satılır və 10 dəfə daha çox baxış alır.</Text>
    </div>
  );
}
  ...
  return (
    <div className='space-y-6'>
      <div className='space-y-2'>
        ...
        <input id='firstName' type='text' className='w-full px-4 py-4 rounded-xl border-2 border-gray-200 focus:border-black focus:outline-none' />
      </div>
      ...
      <div className='space-y-2'>
        ...
        <input id='email' type='email' className='w-full px-4 py-4 rounded-xl border-2 border-gray-200 focus:border-black focus:outline-none' />
      </div>
    </div>
  );
}
...
export function StatsDisplayExample() {
  return (
    <div className='p-6 rounded-xl border-2 border-gray-200 text-center space-y-3'>
      <div className='text-2xl lg:text-3xl font-semibold text-gray-900'>10,000+</div>
    ...
    <div className='min-h-screen flex items-center justify-center bg-white px-6 py-12'>
      <div className='max-w-6xl w-full'>
        <div className='space-y-8'>
          ...
          <Text variant='body-xl' leading='relaxed'>
            In this step, we'll ask you which type of ad you want to create and what category your pet belongs to. Then we'll guide you through the details to
