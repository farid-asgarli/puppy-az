  ...
  return (
    ...
    >
      <div className="w-10 h-10 sm:w-11 sm:h-11 rounded-xl bg-gray-100 flex items-center justify-center flex-shrink-0" aria-hidden="true">
        <Icon size={20} className={cn('sm:w-[22px] sm:h-[22px]', isDanger ? 'text-red-600' : 'text-gray-700')} />
      </div>
      <div className="flex-1 min-w-0">
        <Text
          ...
          className={cn('mb-1 text-sm sm:text-base', isDanger && 'text-red-600')}
          as="div"
        >
          {title}
        </Text>
