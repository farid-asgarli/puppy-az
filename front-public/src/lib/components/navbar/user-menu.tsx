...
import { IconUser, IconHeart, IconPlus, IconSettings, IconLogout, IconReceipt, IconHelpCircle, IconMenu2 } from '@tabler/icons-react';
...
const MenuItem = ({ icon, label, href, onClick, className, variant = 'default' }: MenuItemProps) => {
  ...
  const iconClasses = cn('flex-shrink-0', variant === 'default' && 'text-gray-700', variant === 'danger' && 'text-red-600');
...
export default function NavbarUserMenu() {
  ...
  const menuSections = isAuthenticated ? authenticatedMenuSections : guestMenuSections;
              ...
              <div className="px-4 py-4 bg-gray-50 m-2 rounded-xl border border-gray-200">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <Text variant="body" weight="semibold" className="text-sm truncate text-gray-900">
                      {user.firstName} {user.lastName}
                    </Text>
                    <Text variant="small" className="text-xs truncate text-gray-600">
                      {user.email}
                    </Text>
                  </div>
                </div>
