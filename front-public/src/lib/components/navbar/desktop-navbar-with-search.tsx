...
export function DesktopNavbarWithSearchbar({ categories, initialBreeds, isSticky = true }: DesktopNavbarProps) {
      ...
      <DesktopNavbar isSticky={isSticky} shouldExpand={shouldShowExpanded}>
        ...
        <div
          className={cn(
            ...
            shouldShowExpanded ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-2 pointer-events-none'
          )}
          style={{
        ...
        <div
          ...
          style={{
            top: '50%',
            transform: shouldShowExpanded ? 'translateX(0%) translateY(0px)' : 'translateX(0%) translateY(-50%)',
        ...
        >
          ...
          >
            <SearchBarDesktopAnimated onExpandedChange={handleSearchBarExpandedChange} />
          </SearchBarSyncProvider>
        </div>
      </DesktopNavbar>
    </>
