...
import { IconAlertCircle, IconInfoCircle, IconAlertTriangle, IconCircleCheck } from '@tabler/icons-react';
    ...
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-8 space-y-6 animate-in fade-in zoom-in duration-200">
          {/* Icon */}
          <div className={cn('w-16 h-16 mx-auto rounded-full flex items-center justify-center', config.iconBg)}>
            <IconComponent size={32} className={config.iconColor} strokeWidth={2} />
          </div>

          {/* Title & Description */}
          <div className="text-center space-y-2">
            <h3 className="text-2xl font-semibold font-heading text-gray-900">{title}</h3>
